...
/// <summary>
/// Unit tests for <see cref="FireAndForgetWorkScheduler{TWorkItem}"/>.
...
/// </summary>
public sealed class FireAndForgetWorkSchedulerTests
{
    ...
    public async Task PublishWorkItemAsync_SingleItem_ExecutesItem()
    {
        ...
        await using var scheduler = new FireAndForgetWorkScheduler<TestWorkItem>(
    ...
    public async Task PublishWorkItemAsync_AfterDisposal_ThrowsObjectDisposedException()
    {
        // ARRANGE
        var activityCounter = new AsyncActivityCounter();
        var scheduler = new FireAndForgetWorkScheduler<TestWorkItem>(
